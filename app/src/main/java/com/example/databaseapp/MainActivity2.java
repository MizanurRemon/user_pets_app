...
public class MainActivity2 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
   ...
   private RecyclerView mRecyclerView;
    private petAdapter mRecyclerViewAdapter;
    private petAdapter2 mRecyclerViewAdapter2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //  !!! Need to convert this to RecyclerView listener and use it on edit button
       ...
       /* mRecyclerView.addOnItemTouchListener(new RecyclerItemClickListener(this, new RecyclerItemClickListener.OnItemClickListener() {
        ...
        mRecyclerViewAdapter2 = new petAdapter2(this, new petAdapter2.MyAdapterListener() {
            @Override
     ...
     /*   mRecyclerView = findViewById(R.id.recyclerView);
        ...
        mRecyclerViewAdapter = new petAdapter(this);
    ...
    public void onLoadFinished(@NonNull Loader<Cursor> loader, Cursor data) {
           // mRecyclerViewAdapter.swapCursor(data);
            mRecyclerViewAdapter2.swapCursor(data);
    }

    @Override
    public void onLoaderReset(@NonNull Loader<Cursor> loader) {
       // mRecyclerViewAdapter.swapCursor(null);
        mRecyclerViewAdapter2.swapCursor(null);
    }
