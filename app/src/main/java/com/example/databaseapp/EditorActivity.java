...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private boolean CheckAllFields() {
        ...
        if (mBreedEditText.length() == 0) {
            mBreedEditText.setError("Please Enter breed");
            return false;
        }
        ...
        if (mPriceEditText.length() == 0) {
            mWeightEditText.setError("Price cannot be 0 $");
            return false;
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button savePet = (Button) findViewById(R.id.edit_pet_save);
        savePet.setOnClickListener(save);
    ...
    private void savePet() {
        ...
        if (mCurrentPetUri == null &&
                ...
                TextUtils.isEmpty(weightString) && mGender == petEntry.GENDER_UNKNOWN && TextUtils.isEmpty(priceString) ) {
            return;
        }
        ...
        values.put(petEntry.COLUMN_PET_PRICE, priceString);
   ...
   public boolean onCreateOptionsMenu(Menu menu) {
    ...
    public void onLoadFinished(@NonNull Loader<Cursor> loader, Cursor cursor) {
        ...
        boolean c = cursor.isFirst();
        if (cursor.moveToFirst()) {

            Log.v("CatalogActivity", petEntry.TABLE_NAME + petEntry._ID + "next = " + cursor.moveToNext());
            Log.v("CatalogActivity", petEntry.TABLE_NAME + petEntry._ID + "first = " + cursor.moveToFirst());
